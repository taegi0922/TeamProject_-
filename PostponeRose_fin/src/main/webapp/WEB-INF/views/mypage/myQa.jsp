				...
				<div class="row">
					<div class="col-lg-10" id="mediSerchSection">
						<div class="table-container">
							...
							<br/>
							<h5 id="qaPrescriptTitle">마이QA 문의 내역</h5>
							<br/>
							<div class="card mb-4">
					...
					$.ajax({
						...
						success : function(data) {
							...
							$.each(data, function(index, qa) {
								...
								row.append($("<td data-th='NO.'>").text(qa.qa_id)); // 생성한 tr요소에 게시글 번호가 담긴 td요소 추가
								
								row.append($("<td data-th='작성자'>").text(qa.writer)); 
								...
								var qaTitleTd = $("<td data-th='제목'>").append(qaTitleLink); // a태그를 td태그에 추가
								...
								var qaContextTd = $("<td data-th='내용'>").append(qaContextLink); // a태그를 td태그에 추가
